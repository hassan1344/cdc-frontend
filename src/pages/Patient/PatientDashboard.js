  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="bg-white shadow rounded-lg p-4 mb-6">
        ...
        <p>
          Geschlecht: <strong>{generalInfo.geschlecht}</strong>
        </p>
        <p>
          Größe: <strong>{generalInfo.groeße} cm</strong>
        </p>
        <p>
          Gewicht: <strong>{generalInfo.gewicht} kg</strong>
        </p>
        <p>
          Diabetes Typ: <strong>{generalInfo.diabetestyp}</strong>
        </p>
        <p>
          Dauer der Diabetes: <strong>{generalInfo.dauerDiab} Jahre</strong>
        </p>
        <p>
          Diabetesschulung: <strong>{generalInfo.diabSchulung}</strong>
        </p>
        <p>
          MRSA: <strong>{generalInfo.mrsa}</strong>
        </p>
        <p>
          Letzte Untersuchung: <strong>{generalInfo.datum}</strong>
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="mb-3">
                ...
                <p>
                  Podologische Behandlung: {fussstatus.podologischeBehandlung}
                </p>
              ...
              <div>
                ...
                <p>
                  Dorsalextension Links:{" "}
                  {funktionelleTests.linksDorsalextension}
                </p>
                <p>
                  Dorsalextension Rechts:{" "}
                  {funktionelleTests.rechtsDorsalextension}
                </p>
              </div>
            </div>
          );
